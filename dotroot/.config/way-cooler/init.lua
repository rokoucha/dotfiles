...
way_cooler.programs = {
  ...
  x11_bar = "polybar-example_XWAYLAND0",
}
...
util.program.spawn_at_startup("wc-bg -m tile -f ~/Pictures/wallpaper.jpg")
util.program.spawn_at_startup("fcitx-autostart")
...
way_cooler.windows = {
  ...
  borders = { -- Options for borders
    ...
    size = 10, -- The width of the borders between windows in pixels
...
local keys = {
  ...
  -- Open terminal
  key({ mod }, "return", util.program.spawn_once("tilix")),
